...
var cTotalFrames=20;
var cFrameWidth=87;
var cImageSrc='./images/loader/sprites.png';

var cImageTimeout=false;

function startAnimation(){

    document.getElementsByClassName('loader')[0].innerHTML='<canvas id="canvas" class="loader-canvas" width="'+cWidth+'" height="'+cHeight+'"><p>Your browser does not support the canvas element.</p></canvas>';
